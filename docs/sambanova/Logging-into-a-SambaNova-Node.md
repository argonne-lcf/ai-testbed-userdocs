...
Once you are on the login node, the SambaNova system can be accessed using the alias “sm-01” which resolves to hostname sm-01.ai.alcf.anl.gov.  Or you may use the alias "sm-02".
...
This sets up the SambaFlow software stack, and the associated environmental variables and activates
